function createObjective(objective_name) {
    return `/scoreboard objectives add ${objective_name} dummy`;
}
export function generateBooleanCommand(score_name, condition) {
...
export function generateToggleableCommand(score_name, activation_condition, condition) {
