...
export default function Button({ text, href, onClick, active, border = true }) {
    ...
    return (React.createElement("div", { className: classNames("flex py-1 px-2 bg-background rounded mx-2", "cursor-pointer select-none", text_style, hover_style, border_style), onClick: () => href ? nav(href) : onClick },
